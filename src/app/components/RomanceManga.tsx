        ...
        <div className="flex flex-wrap justify-around pt-[20%] w-[90%]">
            {mangas.map((manga) => (
                <div key={manga.mal_id}>
                    <div className="card shadow-[0px_4px_16px_px_#367E08] h-[400px] w-[280px] group gap-[0.5em]  relative flex justify-end flex-col p-[1.5em] z-[1] overflow-hidden mt-5">
                        <div className="absolute top-0 left-0 h-full w-full border-[#111111] border-5 bg-cover" style={{backgroundImage: `url(${manga.images.jpg.large_image_url})`}}></div>
                    </div>
                    <div className="pt-2">
